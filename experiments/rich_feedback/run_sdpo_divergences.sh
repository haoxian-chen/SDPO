...
# Usage: ./run_sdpo_divergences.sh [--dry-run]
#
# Sweep SDPO on LiveCodeBench v6 across the 5 f-divergences added to
# SelfDistillationConfig.divergence_type (sampled-token branch). All other
# hyperparameters mirror experiments/rich_feedback/run_sdpo.sh; the only
# loss-relevant changes are full_logit_distillation=False and divergence_type.
...
trainer.group_name=SDPO-rich-feedback-div \
